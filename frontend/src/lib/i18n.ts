...
const messages: Record<Locale, Record<string, string>> = {
  en: {
    ...
    'nav.reengagement': 'Needs attention',
    'nav.cleanup': 'Restore & cleanup',
  ...
  ar: {
    ...
    'nav.reengagement': 'يحتاج إلى متابعة',
    'nav.cleanup': 'استعادة وتنظيف',
    'nav.security': 'الأمان والمصادقة الثنائية',
